...
library(MASS)
# Fit the full model 
full.model <- lm(log(qamys) ~  log(wic_mys) + highLS + prop_19 + prop_20_64 + 
                   prop_65 + illiterate_prop + year_1970 + year_1975 + year_1980 +
...
sink("./results/stepmodel_dummyyears_18March20_log.txt")
print(summary(step.model))
sink()

lm1 <- lm(log(qamys) ~  log(wic_mys) + prop_19 + illiterate_prop + 
            year_1970 + year_1975 + year_1980 + year_1985 + year_1990 + 
            year_1995, data = r1)

summ(lm1)

sink("./results/18March20_log_dummyyears.txt")
print(summary(lm1))
sink()
...
par(mfrow = c(2,2))
png("./results/lm1_dummyyears_modelcheck.png")
plot(lm1)
dev.off()
# lmtest::bptest(lm1) 
...
write.csv(df2, "./results/results_log_dummyyears.csv", row.names = F)


# png("./figures/piaac_step_dhs_full_corrected_fit_cc_log_1970_2015.png", width = 5, height = 5, res = 300, units = "in")
png("./figures/fit_log_dummyyears.png", width = 5, height = 5, res = 300, units = "in")
...
pdf("./figures/mys_qamys_1970_2015_plot1_dummyyears.pdf")
...
pdf("./figures/mys_qamys_1970_2015_plot2_dummyyears.pdf")
...
pdf("./figures/mys_qamys_1970_2015_plot3_dummyyears.pdf")
...
plot_name <- paste0("./figures/mys_qamys_dummyyears",unique(df2$year)[i], ".png")
...
pdf("./figures/mys_qamys_1970_2015_countries_dummyyears.pdf")
