...
step_lit_mean_educ123<- step_lit_mean %>% subset(educ!=4) %>%   mutate(mean_country = na.locf(mean_country, na.rm=TRUE, fromLast=TRUE))
...
#====> STEP 5: DIGRESSION: Calculation of age-, sex- and education-specific proportions above and below OECD mean PIAAC literacy score
